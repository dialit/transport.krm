<?php
    ...
    if ($sw_lng <= $ne_lng)
    {
        ...
        //$rows = query("SELECT * FROM stops WHERE ? <= latitude AND latitude <= ? AND (? <= longitude AND longitude <= ?) GROUP BY stops_name", $sw_lat, $ne_lat, $sw_lng, $ne_lng);
    ...
    else
    {
        ...
        //$rows = query("SELECT * FROM stops WHERE ? <= latitude AND latitude <= ? AND (? <= longitude OR longitude <= ?) GROUP_BY stops_name", $sw_lat, $ne_lat, $sw_lng, $ne_lng);
